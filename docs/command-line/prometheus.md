...
| <code class="text-nowrap">--storage.tsdb.exemplars.allow-large-time-window</code> | Allow exemplar out_of_order time_window above 10 minutes Use with server mode only. | `false` |
